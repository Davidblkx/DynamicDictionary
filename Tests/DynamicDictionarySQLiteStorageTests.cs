...
{
    [TestClass]
    public class DynamicDictionarySQLiteStorageTests
    {
        [TestMethod]
        public void SQLiteStorageTests()
        {
            var name = "tests.db3";

            var storage = new DynamicDictionarySQLiteStorage(name);
        ...
        [TestMethod]
        public async Task SQLiteStorageTestsAsync()
        {
            var name = "testsAsync.db3";
